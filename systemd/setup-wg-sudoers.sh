...
# Companion wrapper for `wg-quick save`. Same shape — `sudo -n` against
# the sudoers rule above. The proxy is configured with
# PROXY_WG_QUICK_BIN=/usr/local/sbin/hobe-wg-quick.
